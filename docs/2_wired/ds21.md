...
| :----------- | :--------------- | :---------------- | :------------- |
| 按键层数 <br>Layers | 8 | 8 | |
| 按键数量 <br>Keys | 21 | 21 | 17键 + 4个旋钮数字小键盘 <br>17-key + 4-rotary numeric keypad |
| 套件尺寸 <br>Kit size |  |  |  |
| 套件重量 <br>Kit weight |  |  |  |
...
| 轴体安装方式 <br>Mounting | 轴座热插拔 <br>Hot-swap sockets | 轴座热插拔 <br>Hot-swap sockets |  |
| 灯光 <br>Lighting | RGB轴灯 下灯位 <br>Per-switch RGB, bottom | RGB轴灯 下灯位 <br>Per-switch RGB, bottom |  |
...
| 延迟 <br>Latency | 1ms | 1ms | 理论延迟，实际约2ms左右 <br>Theoretical, ~2ms real |
| 配件 <br>Accessories | Type-c数据线 1米<br>防滑脚贴 <br>USB-C cable 1m, anti-slip feet | Type-c数据线 1米<br>防滑脚贴 <br>USB-C cable 1m, anti-slip feet | 套件及PCB不含数据线 <br>Kit / PCB cable not included |
